...
namespace GraphDownloader.Services
{
    ...
    {
        public async IAsyncEnumerable<JArray> RunPagedQueryAsync(GitHubClient client, string queryText, string repoName, CancellationToken cancel, IProgress<int> progress)
        {
